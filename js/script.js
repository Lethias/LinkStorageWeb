...
function loadContent() {
    ...
    request.onload = function () {
        ...
        if (request.status >= 200 && request.status < 400) {
            ...
            inputdivname.setAttribute('class', 'input-field col s6');
            inputdivdesc.setAttribute('class', 'input-field col s6');
...
function createCard(categoryid, link, place) {
    ...
    visitlinkbutton.setAttribute('href', link.link);
    visitlinkbutton.setAttribute('target', '_blank');
